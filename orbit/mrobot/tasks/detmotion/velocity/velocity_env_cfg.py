...
import orbit.mrobot.tasks.detmotion.velocity.mdp as mdp
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    factory = AssetBaseCfg(
        ...
        spawn=sim_utils.UsdFileCfg(usd_path="asset/usd/FactoryVersion/FactoryVersion.usd",scale=[0.01, 0.01, 0.01]),
    )    
